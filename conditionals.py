...
#     def details(self):
#         print("your name: " + self.customer.name)
#         print("your name: "+ self.customer.username)
#         print("your name: "+ self.customer.creation_date)
#         print( "your name: "+ self.account_no)
...
#         # Storage.store2(type = self.type, account_no = self.account_no, acct_creation_date = self.creation_date, name = self.customer.name, username = self.customer.username, password = self.customer.password, cust_creation_date = self.customer.creation_date )
# class Storage():
#     @staticmethod
#     def store(**kwargs):
...
# cust_2 = Customer("Bolaji", "1234", "holla")
# acct_2 = Account('current', cust_2)
...
class Bank_Account: 
    ...
    user_choice = input("What type of transaction are you doing? (deposit/withdraw) : ")
    def deposit(self): 
            amount_after_deposit=int(input("Enter amount to be Deposited: ")) 
            self.balance += amount_after_deposit
    # return amount

    def withdraw(self): 
            amount_after_withdrawl = int(input("Enter amount to be Withdrawn: ")) 
            if self.balance>=amount_after_withdrawl: 
                self.balance-=amount_after_withdrawl
    # return amount
